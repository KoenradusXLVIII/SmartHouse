                        ...
                        <table id="sensors" class="table table-striped table-bordered">
                          ...
                          <tbody>
                              <?php
                                ...
                                // Query database
                                $query = "SELECT nodes.name AS node, trail.timestamp, trail.level, trail.event AS message FROM trail LEFT JOIN nodes ON trail.node_id = nodes.id WHERE nodes.user_id = '" . $_SESSION['user_id'] ."' ORDER BY timestamp DESC LIMIT 1000";
