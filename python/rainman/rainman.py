...
# Define variables
    ...
    with open('sprinkler.pickle', 'w') as fp:
        pickle.dump([today_high_temp, qpf_allday,lim_days_ahead,sprinkler_mode,sprinkler_duration,sprinkler_times], fp)

with open('sprinkler.pickle') as fp:
    today_high_temp, qpf_allday,lim_days_ahead,sprinkler_mode,sprinkler_duration,sprinkler_times = pickle.load(fp)
